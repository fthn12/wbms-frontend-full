...
const TransactionPKSCancelInView = (props) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    returnWeighInRemark: yup
      ...
      .min(11, "Alasan REJECT (PEMBATALAN) harus melebihi 10 karakter.")
      .max(
        500,
        "Alasan REJECT (PEMBATALAN) tidak boleh melebihi 500 karakter."
      ),
  });
  ...
  return (
    <Box>
      <Header title="TRANSAKSI PKS" subtitle="DATA TIMBANG REJECT WB-IN" />
      {openedTransaction && (
        <Formik
          // enableReinitialize
