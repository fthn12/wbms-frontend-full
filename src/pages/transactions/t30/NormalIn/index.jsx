...
const TransactionT30NormalIn = (props) => {
  ...
  const handleFormikSubmit = async (values) => {
    ...
    try {
      ...
      const response = await transactionAPI.eDispatchT30NormalInAfter(data);
      ...
      navigate(`/wb/transactions/t30-edispatch-normal-in/${id}`);
    } catch (error) {
      setIsLoading(false);
  ...
  return (
    <Box>
      <Header title="TRANSAKSI T30" subtitle="TIMBANG WB-IN" />
      {wbTransaction && (
        <Formik
          // enableReinitialize
