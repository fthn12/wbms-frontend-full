...
const TransactionBulkingWbInNormal = (props) => {
    ...
    <FormControl fullWidth size="small" sx={{ mt: 2 }} required>
      ...
      <Select
        ...
        onChange={(e) => {
          ...
          let selected = dtStorageTanks?.records?.find(
  ...
  return (
    <Box>
      <Header title="TRANSAKSI BULKING" subtitle="WB-skjdjk" />
            ...
            <Grid container columnSpacing={1}>
              <Grid item xs={6}>
                ...
                <TextField
                  ...
                  required
                  label="Segel Mainhole 1 (unloaded)"
                  name="unloadedSeal1"
                  disabled={isSubmitted}
              ...
              <Grid item xs={6}>
                ...
                <TextField
                  ...
                  label="Segel Mainhole 2 (unloaded)"
                  name="unloadedSeal3"
                  disabled={isSubmitted}
