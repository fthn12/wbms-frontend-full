...
const T30BackdateDispatchCancel = (props) => {
        ...
        <Grid container columnSpacing={1}>
          ...
          <Grid item xs={6}>
            <Field
              ...
              // value={moment(values?.returnWeighInTimestamp).format(
              //   "YYYY-MM-DDTHH:mm"
              // )}
              InputLabelProps={{
                shrink: true,
          ...
          <Grid item xs={6}>
            <Field
              ...
              // value={moment(values?.returnWeighOutTimestamp).format(
              //   "YYYY-MM-DDTHH:mm"
              // )}
              InputLabelProps={{
                shrink: true,
          ...
          <Grid item xs={12} sx={{ mt: 2 }}>
            <Divider>TOTAL TIMBANG CANCEL</Divider>
          </Grid>
          <Grid item xs={12}>
            <Field
              type="number"
...
export default T30BackdateDispatchCancel;
