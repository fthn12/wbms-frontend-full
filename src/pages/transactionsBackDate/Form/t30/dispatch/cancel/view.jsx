...
const T30BackdateCancelView = (props) => {
  ...
  return (
    <Box>
      <Header title="TRANSAKSI T30" subtitle="DATA TIMBANG BACKDATE CANCEL" />
      {openedTransaction && (
        <Formik
          // enableReinitialize
        ...
        >
          {(props) => {
            const { values, submitForm, resetForm, handleChange } = props;
...
export default T30BackdateCancelView;
