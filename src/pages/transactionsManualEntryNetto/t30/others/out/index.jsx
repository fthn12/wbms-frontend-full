...
const PksManualEntryNettoOthersOut = () => {
  ...
  const handleFormikSubmit = async (values) => {
    ...
    try {
      ...
      navigate(`/wb/transactions/t30/manual-entry-others-netto-view/${id}`);
  ...
  return (
    <Box>
      <Header title="Transaksi Manual Entry T30" subtitle="Transaksi Manual Entry WB-OUT" />
      {openedTransaction && (
        <Formik
          // enableReinitialize
...
export default PksManualEntryNettoOthersOut;
