    ...
    try {
      ...
      if (WBMS.SITE_TYPE === 1) {
        if (progressStatus === 1) {
          ...
          urlPath = "/wb/transactions/pks/manual-entry-tbs-netto-out";
        } else if (progressStatus === 36) {
          urlPath = "/wb/transactions/pks/manual-entry-kernel-netto-out";
        } else if (progressStatus === 37) {
          urlPath = "/wb/transactions/pks/manual-entry-others-netto-out";
        } else if (progressStatus === 40) {
          urlPath = "/wb/transactions/pks/manual-entry-tbs-netto-view";
        } else if (progressStatus === 41) {
          urlPath = "/wb/transactions/pks/manual-entry-kernel-netto-view";
        } else if (progressStatus === 42) {
          urlPath = "/wb/transactions/pks/manual-entry-other-netto-view";
        ...
        if (progressStatus === 1) {
          ...
          urlPath = "/wb/transactions/t30/manual-entry-others-netto-out";
        } else if (progressStatus === 42) {
          urlPath = "/wb/transactions/t30/manual-entry-others-netto-view";
        } else if (progressStatus === 100) {
          urlPath = "/wb/transactions/t30-edispatch-deleted";
        } else {
          throw new Error("Progress Status tidak valid.");
        ...
        if (progressStatus === 2) {
          ...
          urlPath = "/wb/transactions/bulking/manual-entry-others-netto-out";
        } else if (progressStatus === 47) {
          urlPath = "/wb/transactions/bulking/manual-entry-others-netto-view";
        } else {
          throw new Error("Progress Status tidak valid.");
        }
      }
